...
class PointVector : public std::array<T, N> // object to deal with the 3 dimentionnal problem of raytracing
{
public:
    PointVector() {}
...
template <typename T, std::size_t N>
inline T distance2(const PointVector<T, N> &p1, const PointVector<T, N> &p2)
{
...
template <typename T, std::size_t N>
inline T distance(const PointVector<T, N> &p1, const PointVector<T, N> &p2)
{
